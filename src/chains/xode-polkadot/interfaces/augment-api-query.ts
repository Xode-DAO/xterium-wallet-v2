...
import type { BTreeMap, BTreeSet, Bytes, Null, Option, Vec, bool, u128, u16, u32, u64 } from '@polkadot/types-codec';
import type { AnyNumber, ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, Call, H256 } from '@polkadot/types/interfaces/runtime';
import type { Observable } from '@polkadot/types/types';
import { PalletAssetsAssetAccount, PalletAssetsApproval, PalletAssetsAssetDetails, PalletAssetsAssetMetadata, SpConsensusAuraSr25519AppSr25519Public, PalletBalancesAccountData, FrameSupportTokensMiscIdAmountRuntimeFreezeReason, FrameSupportTokensMiscIdAmountRuntimeHoldReason, PalletBalancesBalanceLock, PalletBalancesReserveData, PalletCollatorSelectionCandidateInfo, PalletContractsWasmCodeInfo, PalletContractsStorageContractInfo, PalletContractsStorageDeletionQueueManager, CumulusPrimitivesCoreAggregateMessageOrigin, PalletMessageQueueBookState, PalletMessageQueuePage, CumulusPalletParachainSystemUnincludedSegmentSegmentTracker, PolkadotPrimitivesV8AbridgedHostConfiguration, PolkadotCorePrimitivesOutboundHrmpMessage, SpTrieStorageProof, CumulusPalletParachainSystemRelayStateSnapshotMessagingStateSnapshot, SpWeightsWeightV2Weight, CumulusPalletParachainSystemUnincludedSegmentAncestor, PolkadotPrimitivesV8UpgradeGoAhead, PolkadotPrimitivesV8UpgradeRestriction, PolkadotPrimitivesV8PersistedValidationData, PalletXcmVersionMigrationStage, XcmVersionedLocation, PalletXcmQueryStatus, StagingXcmV4Instruction, XcmVersionedAssetId, PalletXcmRemoteLockedFungibleRecord, PalletPreimageRequestStatus, PalletPreimageOldRequestStatus, SpCoreCryptoKeyTypeId, XodeRuntimeSessionKeys, FrameSystemAccountInfo, FrameSystemCodeUpgradeAuthorization, FrameSupportDispatchPerDispatchClassWeight, SpRuntimeDigest, FrameSystemEventRecord, FrameSystemPhase, FrameSystemLastRuntimeUpgradeInfo, PalletCollectiveVotes, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletTreasurySpendStatus, CumulusPalletXcmpQueueOutboundChannelDetails, CumulusPalletXcmpQueueQueueConfigData, PalletXodeStakingDelegation, PalletXodeStakingCandidateInfo } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<XodeRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, XodeRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    xodeStaking: {
       ...
       **/
      actualAuthors: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Delegations
       **/
      delegations: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<Vec<PalletXodeStakingDelegation>>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * Desired candidates storage
       **/
      desiredCandidates: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Next block number storage
       **/
      nextBlockNumber: AugmentedQuery<ApiType, () => Observable<Option<u32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Proposed candidates
       **/
      proposedCandidates: AugmentedQuery<ApiType, () => Observable<Vec<PalletXodeStakingCandidateInfo>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Waiting candidates storage (Combination of the desired and proposed candidates)
       **/
      waitingCandidates: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
