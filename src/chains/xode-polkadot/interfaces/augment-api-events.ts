...
import { FrameSupportTokensMiscBalanceStatus, PalletContractsOrigin, StagingXcmV4TraitsOutcome, CumulusPrimitivesCoreAggregateMessageOrigin, SpWeightsWeightV2Weight, FrameSupportMessagesProcessMessageError, StagingXcmV4Location, XcmVersionedAssets, StagingXcmV4AssetAssets, XcmVersionedLocation, XcmV3TraitsError, StagingXcmV4Response, StagingXcmV4Xcm, SpRuntimeDispatchError, FrameSupportDispatchDispatchInfo, FrameSupportDispatchPostDispatchInfo, SpRuntimeDispatchErrorWithPostInfo, PalletBalancesAccountData } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    xodeStaking: {
      DelegationAdded: AugmentedEvent<ApiType, [delegator: AccountId32], { delegator: AccountId32 }>;
      DelegationRevoked: AugmentedEvent<ApiType, [delegator: AccountId32], { delegator: AccountId32 }>;
      DesiredCandidateAdded: AugmentedEvent<ApiType, [desiredCandidate: AccountId32], { desiredCandidate: AccountId32 }>;
      InvulernableAdded: AugmentedEvent<ApiType, [invulnerable: AccountId32], { invulnerable: AccountId32 }>;
      ProposedCandidateAdded: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateBonded: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateCommissionSet: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateLeft: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateOffline: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateOnline: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateRemoved: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      ProposedCandidateTotalStake: AugmentedEvent<ApiType, [proposedCandidate: AccountId32], { proposedCandidate: AccountId32 }>;
      TreasuryAccountRetrieved: AugmentedEvent<ApiType, [treasury: AccountId32, data: PalletBalancesAccountData], { treasury: AccountId32, data: PalletBalancesAccountData }>;
      WaitingCandidateAdded: AugmentedEvent<ApiType, [waitingCandidate: AccountId32], { waitingCandidate: AccountId32 }>;
      WaitingCandidateRemoved: AugmentedEvent<ApiType, [waitingCandidate: AccountId32], { waitingCandidate: AccountId32 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
